...
const { api } = await Kilt.ChainHelpers.BlockchainApiConnection.getConnectionOrConnect()
...
*Request for attestations offer many more functionalities. However, we do not go into the details here.*
