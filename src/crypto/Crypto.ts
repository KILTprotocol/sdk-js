...
export default class Crypto {
  ...
  public static encryptSymmetric (message: Uint8Array, secret: Uint8Array, nonce?: Uint8Array): EncryptedSymmetric {
    return naclEncrypt(message, secret, nonce)
  }

  public static decryptSymmetric (data: EncryptedSymmetric, secret: Uint8Array): Uint8Array | null {
  ...
  public static encryptAsymmetric (message: Uint8Array, publicKeyA: Uint8Array, secretKeyB: Uint8Array): EncryptedAsymmetric {
  ...
  public static decryptAsymmetric (data: EncryptedAsymmetric, publicKeyB: Uint8Array, secretKeyA: Uint8Array): Uint8Array | false {
