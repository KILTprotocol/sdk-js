...
export async function credentialFromChain(
  ...
  const credentialInput = lastRightCredentialCreationCall[0]
  const submitter = lastRightCredentialCreationCall[1]
