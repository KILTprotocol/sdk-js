...
//     const hierarchyDetails = new DelegationHierarchyDetails({
//       rootId: ROOT_IDENTIFIER,
//       cTypeHash: ctypeHash,
//     })
//     await hierarchyDetails
//       .store()
//       .then((tx) =>
...
//       const details = await queriedDelegation.getHierarchyDetails()
//       expect(queriedDelegation.account).toBe(identityAlice.address)
//       expect(details.cTypeHash).toBe(ctypeHash)
...
//           const tuple = mockChainQueryReturn(
//             'delegation',
//             'hierarchies',
//             ctypeHash
//           )
...
//         }
//         const tuple = mockChainQueryReturn('delegation', 'hierarchies', [
//           ctypeHash,
