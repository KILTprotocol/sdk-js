...
export default class DelegationNode implements IDelegationNode {
  ...
  // TODO: hierarchyId can be optional and if not specified it is set the same as the (autogenerated) id.
  public static new(
  ...
  // TODO: Add another method to create a new hierarchy based on the DelegationNode. The method should fail if the node id != hierarchy id.

  public get cTypeHash(): Promise<string> {
    return this.getHierarchyDetails().then(i => i.cTypeHash)
  }
