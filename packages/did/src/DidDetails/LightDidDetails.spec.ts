...
describe('Light DID v1 tests', () => {
  ...
  it('creates base58-encoded LightDidDetails from authentication key and encryption key', () => {
    ...
    expect(did.did).toEqual(
      `did:kilt:light:01${address}:Ac9CMtYCTRWjetJfJqJoV7FcPDD9nHPHDHry7t3KZmvYe1HQP1tgnBuoG3enuGaowpF8V88sCxytDPDy6ZxhW`
    )
  })

  it('creates base58-encoded LightDidDetails from authentication key, encryption key, and service endpoints', () => {
    encryptionDidKeyDetails = {
      publicKey: encPublicKey,
      type: 'x25519',
    }
