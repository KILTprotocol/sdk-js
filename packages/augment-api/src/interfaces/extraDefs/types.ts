...
import type { DidServiceEndpointsDidEndpoint, DidDidDetails, PalletDidLookupLinkableAccountLinkableAccountId, DidDidDetailsDidPublicKeyDetails } from '@polkadot/types/lookup'
...
export interface DipProofRequest extends Struct {
  ...
  // readonly keys: Vec<Hash>; shadowed by the keys() iterator of the Map; this will not be accessible as a property on the object
