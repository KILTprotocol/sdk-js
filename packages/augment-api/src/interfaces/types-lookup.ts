...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletDemocracyMetadataOwner (40) */
  ...
  /** @name SpiritnetRuntimeProxyType (54) */
  ...
  /** @name RuntimeCommonAuthorizationAuthorizationId (64) */
  ...
  /** @name DelegationDelegationHierarchyPermissions (66) */
  ...
  /** @name PalletDidLookupLinkableAccountLinkableAccountId (69) */
  ...
  /** @name PalletDidLookupAccountAccountId20 (70) */
  interface PalletDidLookupAccountAccountId20 extends U8aFixed {}

  /** @name PalletWeb3NamesEvent (72) */
  ...
  /** @name PublicCredentialsEvent (75) */
  ...
  /** @name KiltAssetDidsChainV1ChainId (78) */
  ...
  /** @name KiltAssetDidsAssetV1EvmSmartContractFungibleReference (92) */
  interface KiltAssetDidsAssetV1EvmSmartContractFungibleReference extends U8aFixed {}

  /** @name KiltAssetDidsAssetV1EvmSmartContractNonFungibleReference (93) */
  ...
  /** @name KiltAssetDidsAssetV1GenericAssetId (97) */
  ...
  /** @name CumulusPalletParachainSystemEvent (103) */
  ...
  /** @name CumulusPalletXcmpQueueEvent (104) */
  ...
  /** @name XcmV3JunctionNetworkId (114) */
  ...
  /** @name XcmV3JunctionBodyPart (117) */
  ...
  /** @name XcmV3MultiassetMultiAssets (121) */
  interface XcmV3MultiassetMultiAssets extends Vec<XcmV3MultiAsset> {}

  /** @name XcmV3MultiAsset (123) */
  interface XcmV3MultiAsset extends Struct {
    readonly id: XcmV3MultiassetAssetId;
    readonly fun: XcmV3MultiassetFungibility;
  }

  /** @name XcmV3MultiassetAssetId (124) */
  ...
  /** @name XcmV3MultiassetFungibility (125) */
  ...
  /** @name XcmV3MultiassetAssetInstance (126) */
  ...
  /** @name XcmDoubleEncoded (139) */
  interface XcmDoubleEncoded extends Struct {
    readonly encoded: Bytes;
  }

  /** @name XcmV3QueryResponseInfo (140) */
  ...
  /** @name XcmV3MultiassetMultiAssetFilter (141) */
  ...
  /** @name XcmV3MultiassetWildMultiAsset (142) */
  ...
  /** @name XcmV3MultiassetWildFungibility (143) */
  ...
  /** @name XcmVersionedMultiAssets (145) */
  ...
  /** @name XcmV2MultiassetMultiAssets (146) */
  interface XcmV2MultiassetMultiAssets extends Vec<XcmV2MultiAsset> {}

  /** @name XcmV2MultiAsset (148) */
  interface XcmV2MultiAsset extends Struct {
    readonly id: XcmV2MultiassetAssetId;
    readonly fun: XcmV2MultiassetFungibility;
  }

  /** @name XcmV2MultiassetAssetId (149) */
  ...
  /** @name XcmV2MultiLocation (150) */
  interface XcmV2MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV2MultilocationJunctions;
  }

  /** @name XcmV2MultilocationJunctions (151) */
  ...
  /** @name XcmV2MultiassetFungibility (157) */
  ...
  /** @name XcmV2MultiassetAssetInstance (158) */
  ...
  /** @name XcmVersionedMultiLocation (159) */
  ...
  /** @name CumulusPalletXcmEvent (160) */
  ...
  /** @name CumulusPalletDmpQueueEvent (161) */
  ...
  /** @name PalletTransactionPaymentReleases (199) */
  ...
  /** @name SpConsensusAuraSr25519AppSr25519Public (201) */
  interface SpConsensusAuraSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (202) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name SpiritnetRuntimeSessionKeys (208) */
  ...
  /** @name ParachainStakingRoundInfo (214) */
  ...
  /** @name ParachainStakingSetOrderedSet (218) */
  interface ParachainStakingSetOrderedSet extends Vec<ParachainStakingStake> {}

  /** @name ParachainStakingCandidateStatus (221) */
  ...
  /** @name ParachainStakingInflationStakingInfo (226) */
  ...
  /** @name ParachainStakingError (233) */
  ...
  /** @name SpiritnetRuntimeOriginCaller (251) */
  ...
  /** @name DidOriginDidRawOrigin (255) */
  ...
  /** @name CumulusPalletXcmOrigin (257) */
  ...
  /** @name PalletVestingVestingInfo (260) */
  ...
  /** @name RuntimeCommonAuthorizationPalletAuthorize (273) */
  ...
  /** @name DidDidDetailsDidSignature (277) */
  ...
  /** @name SpCoreEd25519Signature (278) */
  ...
  /** @name DidDidDetailsDidCreationDetails (284) */
  ...
  /** @name DidDidDetailsDidEncryptionKey (286) */
  ...
  /** @name DidDidDetailsDidVerificationKey (290) */
  ...
  /** @name SpCoreEd25519Public (291) */
  interface SpCoreEd25519Public extends U8aFixed {}

  /** @name SpCoreEcdsaPublic (292) */
  interface SpCoreEcdsaPublic extends U8aFixed {}

  /** @name DidServiceEndpointsDidEndpoint (295) */
  ...
  /** @name DidDidDetailsDidAuthorizedCallOperation (303) */
  ...
  /** @name PalletDidLookupAssociateAccountRequest (305) */
  ...
  /** @name SpRuntimeMultiSignature (306) */
  ...
  /** @name PublicCredentialsCall (309) */
  ...
  /** @name PublicCredentialsCredentialsCredential (310) */
  ...
  /** @name CumulusPalletParachainSystemCall (313) */
  ...
  /** @name CumulusPrimitivesParachainInherentParachainInherentData (314) */
  ...
  /** @name PolkadotPrimitivesV2PersistedValidationData (315) */
  ...
  /** @name SpTrieStorageProof (317) */
  interface SpTrieStorageProof extends Struct {
    readonly trieNodes: BTreeSet<Bytes>;
  }

  /** @name PolkadotCorePrimitivesInboundDownwardMessage (320) */
  interface PolkadotCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name PolkadotCorePrimitivesInboundHrmpMessage (323) */
  ...
  /** @name XcmV2MultiassetMultiAssetFilter (336) */
  ...
  /** @name XcmV2MultiassetWildMultiAsset (337) */
  ...
  /** @name XcmV2MultiassetWildFungibility (338) */
  ...
  /** @name CumulusPalletDmpQueueCall (348) */
  ...
  /** @name PalletDemocracyReferendumInfo (352) */
  ...
  /** @name PalletDemocracyReferendumStatus (353) */
  ...
  /** @name PalletDemocracyVoteVoting (355) */
  ...
  /** @name PalletCollectiveVotes (365) */
  ...
  /** @name PalletCollectiveError (366) */
  ...
  /** @name PalletMembershipError (370) */
  ...
  /** @name PalletTreasuryProposal (371) */
  ...
  /** @name FrameSupportPalletId (375) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletTreasuryError (376) */
  ...
  /** @name PalletVestingReleases (380) */
  ...
  /** @name PalletSchedulerScheduled (384) */
  ...
  /** @name PalletProxyProxyDefinition (389) */
  ...
  /** @name PalletProxyAnnouncement (393) */
  ...
  /** @name PalletPreimageRequestStatus (396) */
  ...
  /** @name PalletMultisigMultisig (410) */
  ...
  /** @name AttestationAttestationsAttestationDetails (415) */
  ...
  /** @name KiltSupportDeposit (416) */
  interface KiltSupportDeposit extends Struct {
    readonly owner: AccountId32;
    readonly amount: u128;
  }

  /** @name AttestationError (418) */
  ...
  /** @name DelegationDelegationHierarchyDelegationNode (419) */
  ...
  /** @name DelegationDelegationHierarchyDelegationDetails (422) */
  ...
  /** @name DelegationDelegationHierarchyDelegationHierarchyDetails (423) */
  interface DelegationDelegationHierarchyDelegationHierarchyDetails extends Struct {
    readonly ctypeHash: H256;
  }

  /** @name DelegationError (424) */
  ...
  /** @name PalletDidLookupConnectionRecord (435) */
  interface PalletDidLookupConnectionRecord extends Struct {
    readonly did: AccountId32;
    readonly deposit: KiltSupportDeposit;
  }

  /** @name PalletDidLookupError (437) */
  ...
  /** @name PalletWeb3NamesWeb3NameWeb3NameOwnership (438) */
  ...
  /** @name PublicCredentialsCredentialsCredentialEntry (441) */
  ...
  /** @name PublicCredentialsError (442) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHrmpChannel (449) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHostConfiguration (450) */
  ...
  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (456) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemCodeUpgradeAuthorization (457) */
  interface CumulusPalletParachainSystemCodeUpgradeAuthorization extends Struct {
    readonly codeHash: H256;
    readonly checkVersion: bool;
  }

  /** @name CumulusPalletParachainSystemError (458) */
  ...
  /** @name CumulusPalletXcmpQueueInboundChannelDetails (460) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (461) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (464) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (467) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (468) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (470) */
  ...
  /** @name CumulusPalletXcmpQueueError (472) */
  ...
  /** @name FrameSystemExtensionsCheckNonZeroSender (482) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (483) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (484) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (485) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (488) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u64> {}

  /** @name FrameSystemExtensionsCheckWeight (489) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (490) */
