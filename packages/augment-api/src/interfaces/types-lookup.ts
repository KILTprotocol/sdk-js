...
declare module '@polkadot/types/lookup' {
  ...
  /** @name RuntimeCommonAuthorizationAuthorizationId (43) */
  ...
  /** @name DelegationDelegationHierarchyPermissions (45) */
  ...
  /** @name PalletDidLookupLinkableAccountLinkableAccountId (48) */
  ...
  /** @name PalletDidLookupAccountAccountId20 (49) */
  ...
  /** @name MashnetNodeRuntimeProxyType (54) */
  ...
  /** @name PublicCredentialsEvent (59) */
  ...
  /** @name KiltAssetDidsChainV1ChainId (62) */
  ...
  /** @name KiltAssetDidsAssetV1EvmSmartContractFungibleReference (76) */
  interface KiltAssetDidsAssetV1EvmSmartContractFungibleReference extends U8aFixed {}

  /** @name KiltAssetDidsAssetV1EvmSmartContractNonFungibleReference (77) */
  ...
  /** @name KiltAssetDidsAssetV1GenericAssetId (81) */
  ...
  /** @name SpConsensusAuraEd25519AppEd25519Public (117) */
  interface SpConsensusAuraEd25519AppEd25519Public extends SpCoreEd25519Public {}

  /** @name PalletGrandpaStoredState (120) */
  ...
  /** @name PalletGrandpaStoredPendingChange (121) */
  ...
  /** @name SpFinalityGrandpaEquivocationProof (125) */
  interface SpFinalityGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpFinalityGrandpaEquivocation;
  }

  /** @name SpFinalityGrandpaEquivocation (126) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (127) */
  ...
  /** @name FinalityGrandpaPrecommit (134) */
  ...
  /** @name PalletTransactionPaymentReleases (155) */
  ...
  /** @name RuntimeCommonAuthorizationPalletAuthorize (161) */
  ...
  /** @name DidDidDetailsDidSignature (165) */
  ...
  /** @name SpCoreSr25519Signature (166) */
  interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name SpCoreEcdsaSignature (167) */
  ...
  /** @name DidDidDetailsDidCreationDetails (170) */
  ...
  /** @name DidDidDetailsDidEncryptionKey (172) */
  ...
  /** @name DidDidDetailsDidVerificationKey (176) */
  ...
  /** @name SpCoreSr25519Public (177) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name SpCoreEcdsaPublic (178) */
  interface SpCoreEcdsaPublic extends U8aFixed {}

  /** @name DidServiceEndpointsDidEndpoint (181) */
  ...
  /** @name DidDidDetailsDidAuthorizedCallOperation (189) */
  ...
  /** @name PalletDidLookupAssociateAccountRequest (191) */
  ...
  /** @name PalletDidLookupAccountEthereumSignature (193) */
  ...
  /** @name MashnetNodeRuntimeOriginCaller (202) */
  ...
  /** @name FrameSupportDispatchRawOrigin (203) */
  ...
  /** @name DidOriginDidRawOrigin (204) */
  interface DidOriginDidRawOrigin extends Struct {
    readonly id: AccountId32;
    readonly submitter: AccountId32;
  }

  /** @name PalletProxyCall (205) */
  ...
  /** @name PublicCredentialsCall (208) */
  ...
  /** @name PublicCredentialsCredentialsCredential (209) */
  ...
  /** @name AttestationAttestationsAttestationDetails (214) */
  ...
  /** @name KiltSupportDeposit (215) */
  interface KiltSupportDeposit extends Struct {
    readonly owner: AccountId32;
    readonly amount: u128;
  }

  /** @name AttestationError (217) */
  ...
  /** @name DelegationDelegationHierarchyDelegationNode (218) */
  ...
  /** @name DelegationDelegationHierarchyDelegationDetails (222) */
  ...
  /** @name DelegationDelegationHierarchyDelegationHierarchyDetails (223) */
  interface DelegationDelegationHierarchyDelegationHierarchyDetails extends Struct {
    readonly ctypeHash: H256;
  }

  /** @name DelegationError (224) */
  ...
  /** @name PalletDidLookupConnectionRecord (235) */
  interface PalletDidLookupConnectionRecord extends Struct {
    readonly did: AccountId32;
    readonly deposit: KiltSupportDeposit;
  }

  /** @name PalletDidLookupError (237) */
  ...
  /** @name SpCoreCryptoKeyTypeId (243) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (244) */
  ...
  /** @name PalletAuthorshipUncleEntryItem (246) */
  ...
  /** @name PalletAuthorshipError (248) */
  ...
  /** @name PalletUtilityError (249) */
  interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletProxyProxyDefinition (252) */
  ...
  /** @name PalletProxyAnnouncement (256) */
  ...
  /** @name PalletWeb3NamesWeb3NameWeb3NameOwnership (259) */
  ...
  /** @name PublicCredentialsCredentialsCredentialEntry (262) */
  ...
  /** @name PublicCredentialsError (263) */
  ...
  /** @name FrameSystemExtensionsCheckNonZeroSender (266) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (267) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (268) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (269) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (272) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u64> {}

  /** @name FrameSystemExtensionsCheckWeight (273) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (274) */
