...
import type { DidApiAccountId, PublicCredentialError, PublicCredentialFilter, RawDidDetails, RawDidLinkedInfo, RawServiceEndpoints, StakingRates } from './extraDefs/index.js';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    ProxyType: ProxyType;
    PublicCredentialError: PublicCredentialError;
