...
import type { DidLinkedInfo, RawDidDetails, RawDidLinkedInfo, RawServiceEndpoints, RpcDidDetails, RpcDidEncryptionKey, RpcDidPublicKey, RpcDidVerificationKey, RpcPublicKeyDetails, RpcServiceEndpoint, StakingRates } from './extraDefs/index.js';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    RpcDidDetails: RpcDidDetails;
    RpcDidEncryptionKey: RpcDidEncryptionKey;
    RpcDidPublicKey: RpcDidPublicKey;
    RpcDidVerificationKey: RpcDidVerificationKey;
    RpcMethods: RpcMethods;
    RpcPublicKeyDetails: RpcPublicKeyDetails;
    RpcServiceEndpoint: RpcServiceEndpoint;
