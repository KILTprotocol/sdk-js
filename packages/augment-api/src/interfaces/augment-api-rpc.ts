...
import type { DidLinkedInfo } from './extraDefs/index.js';
// FIXME: Not automatically imported
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    ...
    did: {
       ...
       **/
      query: AugmentedRpc<(did: AccountId32 | string | Uint8Array, at?: Hash | string | Uint8Array) => Observable<Option<DidLinkedInfo>>>;
      /**
       * Return the DID information linked to the provided account, if found.
       **/
      queryByAccount: AugmentedRpc<(account: PalletDidLookupLinkableAccountLinkableAccountId, at?: Hash | string | Uint8Array) => Observable<Option<DidLinkedInfo>>>;
      /**
       * Return the DID information linked to the provided web3name, if found.
       **/
      queryByWeb3Name: AugmentedRpc<(name: Text | string, at?: Hash | string | Uint8Array) => Observable<Option<DidLinkedInfo>>>;
    };
    engine: {
      /**
