...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    publicCredentials: {
       ...
       **/
      credentials: AugmentedQuery<ApiType, (arg1: RuntimeCommonAssetsAssetDid | { chainId?: any; assetId?: any } | string | Uint8Array, arg2: H256 | string | Uint8Array) => Observable<Option<PublicCredentialsCredentialsCredentialEntry>>, [RuntimeCommonAssetsAssetDid, H256]> & QueryableStorageEntry<ApiType, [RuntimeCommonAssetsAssetDid, H256]>;
      /**
       ...
       **/
      credentialSubjects: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<KiltAssetDidsV1AssetDid>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PeregrineRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, PeregrineRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
